...
/**
* Класс, содержащий функции для создания, сжатия и
* работы с tar архивами.
*
* @author	Vincent Blavet <vincent@phpconcept.net>
* @author 	DINI (Некоторые изменения для AFDS)
...
class tar
{
    ...
    * @access public
    */
    function __class_construct( $p_tarname, $p_compress = null )
    {
    ...
    * error text is send to $this->_error.
    ...
    * When the extraction is aborted, $this->_error text is set and false
